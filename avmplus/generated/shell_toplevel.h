...
const uint32_t avmplus_System_private_getEnviron = 60; // native
const uint32_t avmplus_System_readLine = 61; // native
const uint32_t avmplus_System_totalMemory_get = 62; // native
const uint32_t avmplus_System_freeMemory_get = 63; // native
const uint32_t avmplus_System_privateMemory_get = 64; // native
const uint32_t avmplus_System_forceFullCollection = 65; // native
const uint32_t avmplus_System_queueCollection = 66; // native
const uint32_t avmplus_System_ns_example_nstest = 67; // native
const uint32_t avmplus_System_isGlobal = 68; // native
const uint32_t avmplus_System_swfVersion_get = 69; // native
const uint32_t avmplus_System_apiVersion_get = 70; // native
const uint32_t avmplus_System_disposeXML = 71; // native
const uint32_t avmplus_System_deopt = 72; // native
const uint32_t avmplus_System_pauseForGCIfCollectionImminent = 73; // native
const uint32_t avmplus_System_is64bit = 74; // native
...
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fork = 205; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_read = 206; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_write = 207; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_open = 208; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_close = 209; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_wait4 = 210; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_link = 211; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_unlink = 212; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_chdir = 213; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fchdir = 214; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_chmod = 215; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_chown = 216; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_lseek = 217; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getpid = 218; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setuid = 219; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getuid = 220; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_geteuid = 221; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_access = 222; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sync = 223; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_kill = 224; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getppid = 225; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_dup = 226; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_pipe = 227; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getegid = 228; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getgid = 229; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_ioctl = 230; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_revoke = 231; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_symlink = 232; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_umask = 233; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_chroot = 234; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_msync = 235; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_vfork = 236; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getgroups = 237; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setgroups = 238; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getpgrp = 239; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setpgid = 240; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getdtablesize = 241; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_dup2 = 242; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fcntl = 243; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fsync = 244; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setpriority = 245; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_socket = 246; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getpriority = 247; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setsockopt = 248; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_listen = 249; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sigsuspend = 250; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getrusage = 251; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getsockopt = 252; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_readv = 253; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_writev = 254; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fchown = 255; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fchmod = 256; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setreuid = 257; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setregid = 258; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_rename = 259; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_mkfifo = 260; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_shutdown = 261; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_socketpair = 262; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_mkdir = 263; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_rmdir = 264; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setsid = 265; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getdirentries = 266; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setgid = 267; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_setegid = 268; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_seteuid = 269; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_stat = 270; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fstat = 271; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_lstat = 272; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_pathconf = 273; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_fpathconf = 274; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getpgid = 275; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_semget = 276; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_msgget = 277; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_msgsnd = 278; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_msgrcv = 279; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_shmdt = 280; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_shmget = 281; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_clock_gettime = 282; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_nanosleep = 283; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_lchown = 284; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_getsid = 285; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sched_yield = 286; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sched_get_priority_max = 287; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sched_get_priority_min = 288; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sigprocmask = 289; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sigpending = 290; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_sigwait = 291; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_shm_unlink = 292; // abc
const uint32_t flash_utils_IKernel_flash_utils_IKernel_pselect = 293; // abc
const uint32_t native_script_function_flash_sampler_getMasterString = 296; // native
const uint32_t native_script_function_flash_sampler_getSavedThis = 297; // native
const uint32_t native_script_function_flash_sampler_getLexicalScopes = 298; // native
const uint32_t native_script_function_flash_sampler_isGetterSetter = 299; // native
const uint32_t native_script_function_flash_sampler__getInvocationCount = 300; // native
const uint32_t native_script_function_flash_sampler_getSampleCount = 304; // native
const uint32_t native_script_function_flash_sampler__getSamples = 305; // native
const uint32_t native_script_function_flash_sampler_getMemberNames = 307; // native
const uint32_t native_script_function_flash_sampler_getSize = 308; // native
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 309; // native
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 312; // native
const uint32_t native_script_function_flash_sampler_pauseSampling = 313; // native
const uint32_t native_script_function_flash_sampler_stopSampling = 314; // native
const uint32_t native_script_function_flash_sampler_startSampling = 315; // native
const uint32_t native_script_function_flash_sampler_clearSamples = 316; // native
const uint32_t flash_sampler_StackFrame_toString = 318; // abc
const uint32_t flash_sampler_NewObjectSample_object_get = 325; // native
const uint32_t flash_sampler_NewObjectSample_size_get = 326; // native
const uint32_t flash_trace_Trace_setLevel = 332; // native
const uint32_t flash_trace_Trace_getLevel = 333; // native
const uint32_t flash_trace_Trace_setListener = 334; // native
const uint32_t flash_trace_Trace_getListener = 335; // native
const uint32_t flash_system_WorkerState_code = 342; // abc
const uint32_t flash_system_Worker_current_get = 345; // abc
const uint32_t flash_system_Worker_pr = 346; // native
const uint32_t flash_system_Worker_state_get = 348; // native
const uint32_t flash_system_Worker_start = 349; // native
const uint32_t flash_system_Worker_isParentOf = 350; // native
const uint32_t flash_system_Worker_isPrimordial_get = 351; // native
const uint32_t flash_system_Worker_setSharedProperty = 352; // native
const uint32_t flash_system_Worker_getSharedProperty = 353; // native
const uint32_t flash_system_Worker_terminate = 354; // native
const uint32_t flash_system_WorkerEvent_currentState_get = 357; // abc
const uint32_t flash_system_WorkerEvent_previousState_get = 358; // abc
const uint32_t flash_system_WorkerEvent_target_get = 359; // abc
const uint32_t flash_system_WorkerDomain_current_get = 362; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromByteArray = 364; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromPrimordial = 365; // abc
const uint32_t flash_system_WorkerDomain_private_createWorkerFromByteArrayInternal = 366; // native
const uint32_t flash_system_WorkerDomain_listWorkers = 367; // native
const uint32_t flash_utils_ShellPosix_getAppPath = 370; // native
const uint32_t flash_utils_ShellPosix_fork = 371; // native
const uint32_t flash_utils_ShellPosix_read = 372; // native
const uint32_t flash_utils_ShellPosix_write = 373; // native
const uint32_t flash_utils_ShellPosix_open = 374; // native
const uint32_t flash_utils_ShellPosix_close = 375; // native
const uint32_t flash_utils_ShellPosix_wait4 = 376; // native
const uint32_t flash_utils_ShellPosix_link = 377; // native
const uint32_t flash_utils_ShellPosix_unlink = 378; // native
const uint32_t flash_utils_ShellPosix_chdir = 379; // native
const uint32_t flash_utils_ShellPosix_fchdir = 380; // native
const uint32_t flash_utils_ShellPosix_chmod = 381; // native
const uint32_t flash_utils_ShellPosix_chown = 382; // native
const uint32_t flash_utils_ShellPosix_lseek = 383; // native
const uint32_t flash_utils_ShellPosix_getpid = 384; // native
const uint32_t flash_utils_ShellPosix_setuid = 385; // native
const uint32_t flash_utils_ShellPosix_getuid = 386; // native
const uint32_t flash_utils_ShellPosix_geteuid = 387; // native
const uint32_t flash_utils_ShellPosix_access = 388; // native
const uint32_t flash_utils_ShellPosix_sync = 389; // native
const uint32_t flash_utils_ShellPosix_kill = 390; // native
const uint32_t flash_utils_ShellPosix_getppid = 391; // native
const uint32_t flash_utils_ShellPosix_dup = 392; // native
const uint32_t flash_utils_ShellPosix_pipe = 393; // native
const uint32_t flash_utils_ShellPosix_getegid = 394; // native
const uint32_t flash_utils_ShellPosix_getgid = 395; // native
const uint32_t flash_utils_ShellPosix_ioctl = 396; // native
const uint32_t flash_utils_ShellPosix_revoke = 397; // native
const uint32_t flash_utils_ShellPosix_symlink = 398; // native
const uint32_t flash_utils_ShellPosix_umask = 399; // native
const uint32_t flash_utils_ShellPosix_chroot = 400; // native
const uint32_t flash_utils_ShellPosix_msync = 401; // native
const uint32_t flash_utils_ShellPosix_vfork = 402; // native
const uint32_t flash_utils_ShellPosix_getgroups = 403; // native
const uint32_t flash_utils_ShellPosix_setgroups = 404; // native
const uint32_t flash_utils_ShellPosix_getpgrp = 405; // native
const uint32_t flash_utils_ShellPosix_setpgid = 406; // native
const uint32_t flash_utils_ShellPosix_getdtablesize = 407; // native
const uint32_t flash_utils_ShellPosix_dup2 = 408; // native
const uint32_t flash_utils_ShellPosix_fcntl = 409; // native
const uint32_t flash_utils_ShellPosix_fsync = 410; // native
const uint32_t flash_utils_ShellPosix_setpriority = 411; // native
const uint32_t flash_utils_ShellPosix_socket = 412; // native
const uint32_t flash_utils_ShellPosix_getpriority = 413; // native
const uint32_t flash_utils_ShellPosix_setsockopt = 414; // native
const uint32_t flash_utils_ShellPosix_listen = 415; // native
const uint32_t flash_utils_ShellPosix_sigsuspend = 416; // native
const uint32_t flash_utils_ShellPosix_getrusage = 417; // native
const uint32_t flash_utils_ShellPosix_getsockopt = 418; // native
const uint32_t flash_utils_ShellPosix_readv = 419; // native
const uint32_t flash_utils_ShellPosix_writev = 420; // native
const uint32_t flash_utils_ShellPosix_fchown = 421; // native
const uint32_t flash_utils_ShellPosix_fchmod = 422; // native
const uint32_t flash_utils_ShellPosix_setreuid = 423; // native
const uint32_t flash_utils_ShellPosix_setregid = 424; // native
const uint32_t flash_utils_ShellPosix_rename = 425; // native
const uint32_t flash_utils_ShellPosix_mkfifo = 426; // native
const uint32_t flash_utils_ShellPosix_shutdown = 427; // native
const uint32_t flash_utils_ShellPosix_socketpair = 428; // native
const uint32_t flash_utils_ShellPosix_mkdir = 429; // native
const uint32_t flash_utils_ShellPosix_rmdir = 430; // native
const uint32_t flash_utils_ShellPosix_setsid = 431; // native
const uint32_t flash_utils_ShellPosix_getdirentries = 432; // native
const uint32_t flash_utils_ShellPosix_setgid = 433; // native
const uint32_t flash_utils_ShellPosix_setegid = 434; // native
const uint32_t flash_utils_ShellPosix_seteuid = 435; // native
const uint32_t flash_utils_ShellPosix_stat = 436; // native
const uint32_t flash_utils_ShellPosix_fstat = 437; // native
const uint32_t flash_utils_ShellPosix_lstat = 438; // native
const uint32_t flash_utils_ShellPosix_pathconf = 439; // native
const uint32_t flash_utils_ShellPosix_fpathconf = 440; // native
const uint32_t flash_utils_ShellPosix_getpgid = 441; // native
const uint32_t flash_utils_ShellPosix_semget = 442; // native
const uint32_t flash_utils_ShellPosix_msgget = 443; // native
const uint32_t flash_utils_ShellPosix_msgsnd = 444; // native
const uint32_t flash_utils_ShellPosix_msgrcv = 445; // native
const uint32_t flash_utils_ShellPosix_shmdt = 446; // native
const uint32_t flash_utils_ShellPosix_shmget = 447; // native
const uint32_t flash_utils_ShellPosix_clock_gettime = 448; // native
const uint32_t flash_utils_ShellPosix_nanosleep = 449; // native
const uint32_t flash_utils_ShellPosix_lchown = 450; // native
const uint32_t flash_utils_ShellPosix_getsid = 451; // native
const uint32_t flash_utils_ShellPosix_sched_yield = 452; // native
const uint32_t flash_utils_ShellPosix_sched_get_priority_max = 453; // native
const uint32_t flash_utils_ShellPosix_sched_get_priority_min = 454; // native
const uint32_t flash_utils_ShellPosix_sigprocmask = 455; // native
const uint32_t flash_utils_ShellPosix_sigpending = 456; // native
const uint32_t flash_utils_ShellPosix_sigwait = 457; // native
const uint32_t flash_utils_ShellPosix_shm_unlink = 458; // native
const uint32_t flash_utils_ShellPosix_pselect = 459; // native
...
extern avmplus::Atom avmplus_System_private_getEnviron_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom avmplus_System_private_getEnviron_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
private:
    ...
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_environ;
public:
    REALLY_INLINE void gcTracePrivateProperties(MMgc::GC* gc)
    {
        gc->TraceLocation(&m_argv);
        gc->TraceLocation(&m_environ);
    }
};
#define DECLARE_SLOTS_SystemClass \
    ...
    public: \
        REALLY_INLINE avmplus::ArrayObject* get_environ() const { return m_slots_SystemClass.m_environ; } \
        REALLY_INLINE void setconst_environ(avmplus::ArrayObject* newVal) { m_slots_SystemClass.m_environ = newVal; } \
    private: \
