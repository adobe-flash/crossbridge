...
void S_PaintChannels(int endtime)
{
	...
	// paint in the channels.
...
#ifdef __AVM2__
		{
			inline_as3(
				...
				"var sndData:ByteArray = CModule.activeConsole.sndDataBuffer\n");
			...
			for(i = 0; i < end - paintedtime; i++)
			{
				...
				l = (float)paintbuffer[i].left * paintMultiple;
				r = (float)paintbuffer[i].right * paintMultiple;
				
				inline_as3(
				"sndData.writeFloat(%0)\n"
				"sndData.writeFloat(%1)\n"
				"sndData.writeFloat(%0)\n"
				"sndData.writeFloat(%1)\n"
				"sndData.writeFloat(%0)\n"
				"sndData.writeFloat(%1)\n"
	...
	AS3_SendMetricInt("quake1.activesounds", numactivesounds);
}
