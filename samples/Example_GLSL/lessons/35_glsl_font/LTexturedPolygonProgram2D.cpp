...
bool LTexturedPolygonProgram2D::loadProgram()
{
	...
	//Load vertex shader
	GLuint vertexShader = loadShaderFromFile( "35_glsl_font/LTexturedPolygonProgram2D.glvs", GL_VERTEX_SHADER );
	...
	GLuint fragmentShader = loadShaderFromFile( "35_glsl_font/LTexturedPolygonProgram2D.glfs", GL_FRAGMENT_SHADER );
