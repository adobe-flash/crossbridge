...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 297,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 814,           /* -fset-stack-executable */
  ...
  OPT_imultilib = 970,                       /* -imultilib */
  OPT_include = 971,                         /* -include */
  OPT_iplugindir_ = 972,                     /* -iplugindir= */
  OPT_iprefix = 973,                         /* -iprefix */
  OPT_iquote = 974,                          /* -iquote */
  OPT_isysroot = 975,                        /* -isysroot */
  OPT_isystem = 976,                         /* -isystem */
  OPT_iwithprefix = 977,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 978,               /* -iwithprefixbefore */
  OPT_k8 = 979,                              /* -k8 */
  OPT_l = 980,                               /* -l */
  OPT_lang_asm = 981,                        /* -lang-asm */
  OPT_m128bit_long_double = 982,             /* -m128bit-long-double */
  OPT_m32 = 983,                             /* -m32 */
  OPT_m3dnow = 984,                          /* -m3dnow */
  OPT_m3dnowa = 985,                         /* -m3dnowa */
  OPT_m64 = 986,                             /* -m64 */
  OPT_m80387 = 987,                          /* -m80387 */
  OPT_m8bit_idiv = 988,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 989,              /* -m96bit-long-double */
  OPT_mabi_ = 990,                           /* -mabi= */
  OPT_mabm = 991,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 992,       /* -maccumulate-outgoing-args */
  OPT_maes = 993,                            /* -maes */
  OPT_malign_double = 994,                   /* -malign-double */
  OPT_malign_functions_ = 995,               /* -malign-functions= */
  OPT_malign_jumps_ = 996,                   /* -malign-jumps= */
  OPT_malign_loops_ = 997,                   /* -malign-loops= */
  OPT_malign_stringops = 998,                /* -malign-stringops */
  OPT_march_ = 999,                          /* -march= */
  OPT_masm_ = 1000,                          /* -masm= */
  OPT_mavx = 1001,                           /* -mavx */
  OPT_mavx2 = 1002,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1003,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1004,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1005,                           /* -mbmi */
  OPT_mbmi2 = 1006,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1007,                  /* -mbranch-cost= */
  OPT_mcld = 1008,                           /* -mcld */
  OPT_mcmodel_ = 1009,                       /* -mcmodel= */
  OPT_mconsole = 1010,                       /* -mconsole */
  /* OPT_mcpu_ = 1011, */                    /* -mcpu= */
  OPT_mcrc32 = 1012,                         /* -mcrc32 */
  OPT_mcx16 = 1013,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1014,            /* -mdispatch-scheduler */
  OPT_mdll = 1015,                           /* -mdll */
  OPT_mf16c = 1016,                          /* -mf16c */
  OPT_mfancy_math_387 = 1017,                /* -mfancy-math-387 */
  OPT_mfentry = 1018,                        /* -mfentry */
  OPT_mfma = 1019,                           /* -mfma */
  OPT_mfma4 = 1020,                          /* -mfma4 */
  OPT_mforce_drap = 1021,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1022,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1023,                       /* -mfpmath= */
  OPT_mfsgsbase = 1024,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1025, */              /* -mfused-madd */
  OPT_mhard_float = 1026,                    /* -mhard-float */
  OPT_mieee_fp = 1027,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1028,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1029,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1030,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1031, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1032,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1033,                           /* -mlwp */
  OPT_mlzcnt = 1034,                         /* -mlzcnt */
  OPT_mmmx = 1035,                           /* -mmmx */
  OPT_mmovbe = 1036,                         /* -mmovbe */
  OPT_mms_bitfields = 1037,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1038,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1039,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1040,                  /* -mno-push-args */
  OPT_mno_red_zone = 1041,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1042,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1043,             /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 1044,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1045,                          /* -mpc32 */
  OPT_mpc64 = 1046,                          /* -mpc64 */
  OPT_mpc80 = 1047,                          /* -mpc80 */
  OPT_mpclmul = 1048,                        /* -mpclmul */
  OPT_mpe_aligned_commons = 1049,            /* -mpe-aligned-commons */
  ...
  OPT_mtbm = 1076,                           /* -mtbm */
  OPT_mthreads = 1077,                       /* -mthreads */
  OPT_mtls_dialect_ = 1078,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1079,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1080,                         /* -mtune= */
  OPT_muse_libstdc_wrappers = 1081,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1082,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1083,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1084,                    /* -mvzeroupper */
  OPT_mwin32 = 1085,                         /* -mwin32 */
  OPT_mwindows = 1086,                       /* -mwindows */
  OPT_mx32 = 1087,                           /* -mx32 */
  OPT_mxop = 1088,                           /* -mxop */
  OPT_n = 1089,                              /* -n */
  OPT_no_canonical_prefixes = 1090,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1091,              /* -no-integrated-cpp */
  OPT_no_pthread = 1092,                     /* -no-pthread */
  OPT_nocpp = 1093,                          /* -nocpp */
  OPT_nodefaultlibs = 1094,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1095,                   /* -nostartfiles */
  OPT_nostdinc = 1096,                       /* -nostdinc */
  OPT_nostdinc__ = 1097,                     /* -nostdinc++ */
  OPT_nostdlib = 1098,                       /* -nostdlib */
  OPT_o = 1099,                              /* -o */
  OPT_p = 1100,                              /* -p */
  OPT_pass_exit_codes = 1101,                /* -pass-exit-codes */
  OPT_pedantic = 1102,                       /* -pedantic */
  OPT_pedantic_errors = 1103,                /* -pedantic-errors */
  OPT_pg = 1104,                             /* -pg */
  OPT_pie = 1105,                            /* -pie */
  OPT_pipe = 1106,                           /* -pipe */
  OPT_posix = 1107,                          /* -posix */
  OPT_print_file_name_ = 1108,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1109,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1110,          /* -print-multi-directory */
  OPT_print_multi_lib = 1111,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1112,       /* -print-multi-os-directory */
