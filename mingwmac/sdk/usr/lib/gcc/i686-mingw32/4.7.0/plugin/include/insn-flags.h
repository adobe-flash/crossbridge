...
#define HAVE_avx_movups256 ((TARGET_SSE) && (TARGET_AVX))
#define HAVE_sse_movups (TARGET_SSE)
#define HAVE_avx_movupd256 ((TARGET_SSE) && (TARGET_AVX))
#define HAVE_sse2_movupd ((TARGET_SSE) && (TARGET_SSE2))
#define HAVE_avx_movdqu256 ((TARGET_SSE2) && (TARGET_AVX))
...
static inline rtx gen_atomic_iordi                      (rtx, rtx, rtx);
static inline rtx
gen_atomic_iordi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
