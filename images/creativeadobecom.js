...
function s_doPlugins(s) {
  ...
  if(typeof(s.pageName)!=="undefined" && s.pageName.indexOf("Plans_PageView")!=-1 ) {
    ...
    if (Adobe.CheckoutAnyware.ConfigModel.country == "DE" || Adobe.CheckoutAnyware.ConfigModel.country == "FR") 
    ...
    else if (Adobe.CheckoutAnyware.ConfigModel.country == "AU") s.contextData['sc.currency']="AUD";
  ...
  if(s.pageName!=="undefined" && s.events=='purchase' && s.purchaseID!='') {
    ...
    if (s.products.indexOf("CreativeCloud")!=-1 && s.products.indexOf("Promo")!=-1) {
	scSubType='promo';
    ...
    if (scProd.length==6) {
      ...
      cjFrame.src="https://www.emjcd.com/tags/c?CID=1359820&TYPE=108254&CURRENCY="+s.currencyCode+"&ITEM1="+scSKUName+"&AMT1="+scProd[3]+"&QTY1="+scProd[2]+"&OID="+s.purchaseID;
      ...
      cjFrame1.src="https://www.emjcd.com/tags/c?containerTagId=3035&CID=1359820&TYPE=358746&CURRENCY="+s.currencyCode+"&ITEM1="+scSKUName+"&AMT1="+scProd[3]+"&QTY1="+scProd[2]+"&OID="+s.purchaseID;
	...
	if (s.currencyCode=='USD') {
	  ...
	  mboxDefine('tntOrderConfirm','acom_en_orderConfirmPage', 'productPurchasedId=/Applications/CreativeCloud', 'orderTotal='+scProd[3], 'orderId='+s.purchaseID);
        mboxUpdate('acom_en_orderConfirmPage','productPurchasedId=/Applications/CreativeCloud','orderTotal='+scProd[3], 'orderId='+s.purchaseID);
}
   }
  }
  if(!s.pageName && document.referrer!='' && (document.URL=='https://creative.adobe.com/apps#' || document.URL=='https://creative.adobe.com/files/#' || document.URL=='https://creative.adobe.com/')) {
...
  if (!s.pageName|| "file:" == document.location.protocol) s.abort=true;
  else {
