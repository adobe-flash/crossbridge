...
// AVM2 specific code!!!
void failOnUndefinedSyms(Sized_symbol<32>* sym)
{
    //printf("sym: %p %s\n", sym, sym->demangled_name().c_str());
    if(sym->is_undefined() && !sym->is_weak_undefined())
...
{
  // AVM2 specific code!!!
  this->symtab_->for_all_symbols<32, void (&)(gold::Sized_symbol<32>*)>(failOnUndefinedSyms);
  // AVM2 specific code!!!
