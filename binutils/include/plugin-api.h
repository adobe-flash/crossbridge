...
(*ld_plugin_register_cleanup) (ld_plugin_cleanup_handler handler);
    ...
    /* The linker's interface for getting the "claim file" handler.  */
    
    typedef
    ld_plugin_claim_file_handler
    (*ld_plugin_get_claim_file) ();
    
    /* The linker's interface for getting the "all symbols read" handler.  */
    
    typedef
    ld_plugin_all_symbols_read_handler
    (*ld_plugin_get_all_symbols_read) ();
    
    /* The linker's interface for getting the cleanup handler.  */
    
    typedef
    ld_plugin_cleanup_handler
    (*ld_plugin_get_cleanup) ();
...
/* The linker's interface for allowing plugins to claim files during the replacement phase  */

typedef
enum ld_plugin_status
(*ld_plugin_set_always_rescan) ();
...
enum ld_plugin_tag
{
  ...
  LDPT_GNU_LD_VERSION,
  LDPT_GET_VIEW,
  LDPT_SET_ALWAYS_RESCAN,
    LDPT_GET_CLAIM_FILE_HOOK,
    LDPT_GET_ALL_SYMBOLS_READ_HOOK,
    LDPT_GET_CLEANUP_HOOK
};
...
struct ld_plugin_tv
{
  ...
  union
  {
    ...
    ld_plugin_register_cleanup tv_register_cleanup;
      ld_plugin_get_claim_file tv_get_claim_file;
      ld_plugin_get_all_symbols_read tv_get_all_symbols_read;
      ld_plugin_get_cleanup tv_get_cleanup;
    ...
    ld_plugin_set_always_rescan tv_set_always_rescan;
  } tv_u;
};
